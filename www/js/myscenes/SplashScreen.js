var SplashScreen = (function () {
    ...
    SplashScreen.prototype.show = function (next) {
        ...
        var myName = this.stage.drawText(screenWidth / 2, screenHeight / 6, 'Raphael Stary', tileWidth * 4, 'Arial', 'black');

        var presents = this.stage.drawText(screenWidth / 2, screenHeight / 3, 'presents', tileWidth * 2, 'Arial');
        var gameName = this.stage.drawText(screenWidth / 2, screenHeight / 2, 'POOPY PLANES', tileWidth * 6,
            'Arial');

        var gameJamEdition = this.stage.drawText(screenWidth / 2, screenHeight / 2 + tileWidth * 6, "game jam edition", tileWidth * 2,
            'Arial', 'darkgreen');

        var gameControls = this.stage.drawText(screenWidth / 2, screenHeight / 4 * 3, "press 'START' to continue", tileWidth * 2,
            'Arial', 'darkblue');
